# AppleScript for setting ScreenSaver's askForPasswordAfter settings on OS X >= 10.8 (Korean locale)
#
	...
	tell application "System Preferences"
		...
		tell application "System Events"
			tell process "System Preferences"
				tell first tab group of first window
					...
					click menu item nthOption of menu 1 of pb
				end tell
			end tell
		end tell
		quit
